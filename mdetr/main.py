...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.eval_skip == 0:
            ...
            if args.do_qa:
                if len(args.combine_datasets)==1: metric = test_stats[f"{args.combine_datasets[0]}_accuracy_answer_total_unscaled"]
                else: metric=test_stats["gqa_accuracy_answer_total_unscaled"]
            else:
